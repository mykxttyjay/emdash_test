...
import { f as createAuthorizationUrl } from './index_CZ_O-7V7.mjs';
...
const GET = async ({ params, request, locals, redirect }) => {
  ...
  try {
    ...
    const providers = getOAuthConfig(locals.runtime?.env ?? Object.assign(__vite_import_meta_env__, { OS: "Windows_NT" }));
