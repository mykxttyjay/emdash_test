...
const bylineTranslationCreateBody = z.object({
...
widgetAreaWithWidgetsSchema.extend({ widgetCount: z.number().int() }).meta({ id: "WidgetAreaWithWidgetsAndCount" });
...
export { notFoundListQuery as $, contentPublishBody as A, contentScheduleBody as B, contentTermsBody as C, contentUpdateBody as D, contentListQuery as E, contentCreateBody as F, importProbeBody as G, wpMediaImportBody as H, wpPrepareBody as I, wpRewriteUrlsBody as J, wpPluginAnalyzeBody as K, wpPluginExecuteBody as L, contentBylineInputSchema as M, contentSeoInput as N, DEFAULT_MAX_UPLOAD_SIZE as O, mediaUploadUrlBody as P, mediaConfirmBody as Q, mediaUpdateBody as R, formatFileSize as S, mediaListQuery as T, updateMenuItemBody as U, localeFilterQuery as V, createMenuItemBody as W, reorderMenuItemsBody as X, updateMenuBody as Y, createMenuBody as Z, notFoundSummaryQuery as _, allowedDomainUpdateBody as a, notFoundPruneBody as a0, updateRedirectBody as a1, redirectsListQuery as a2, createRedirectBody as a3, fieldReorderBody as a4, updateFieldBody as a5, createFieldBody as a6, collectionGetQuery as a7, updateCollectionBody as a8, createCollectionBody as a9, orphanRegisterBody as aa, searchEnableBody as ab, searchRebuildBody as ac, searchSuggestQuery as ad, searchQuery as ae, updateSectionBody as af, sectionsListQuery as ag, createSectionBody as ah, settingsUpdateBody as ai, setupAdminVerifyBody as aj, setupAdminBody as ak, setupBody as al, updateTermBody as am, createTermBody as an, createTaxonomyDefBody as ao, reorderWidgetsBody as ap, updateWidgetBody as aq, createWidgetBody as ar, createWidgetAreaBody as as, allowedDomainCreateBody as b, bylineTranslationCreateBody as c, bylineUpdateBody as d, bylinesListQuery as e, bylineCreateBody as f, commentBulkBody as g, commentStatusBody as h, commentListQuery as i, usersListQuery as j, inviteCompleteBody as k, inviteRegisterOptionsBody as l, inviteCreateBody as m, magicLinkSendBody as n, authMeActionBody as o, passkeyOptionsBody as p, passkeyRegisterOptionsBody as q, passkeyRegisterVerifyBody as r, passkeyVerifyBody as s, passkeyRenameBody as t, userUpdateBody as u, signupCompleteBody as v, signupRequestBody as w, createCommentBody as x, contentTrashQuery as y, contentPreviewUrlBody as z };
