import { _ as __exportAll, e as encodeCursor, v as validateIdentifier, d as decodeCursor, a as isPostgres, c as currentTimestampValue } from './types-ByV5sgsv_DJ3e8Y6Y.mjs';
...
async function loadVirtualModules() {
	if (virtualConfig === void 0) virtualConfig = (await import('./config_kQwpNaU2.mjs')).default;
	if (virtualCreateDialect === void 0) virtualCreateDialect = (await import('./dialect_D_z8L6bH.mjs')).createDialect;
}
/**
...
const loaderChm5h7Gr = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	__proto__: null,
	i: loader_exports,
	n: emdashLoader,
	r: getDb,
...
export { CURSOR_RAW_VALUES as C, createRecorder as c, flushRecorder as f, getDb as g, isInstrumentationEnabled as i, kyselyLogOption as k, loaderChm5h7Gr as l };
