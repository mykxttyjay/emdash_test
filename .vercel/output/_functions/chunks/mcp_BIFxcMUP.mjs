...
import { M as contentBylineInputSchema, N as contentSeoInput } from './setup-Cf_TyOv5_Da69AHYi.mjs';
...
function createMcpServer() {
	...
	server.registerTool("schema_list_collections", {
		...
		const ec = getEmDash(extra);
		try {
			const { SchemaRegistry } = await import('./schema-Djdlfi5G_Fa5xGGKC.mjs').then((n) => n.t);
	...
	server.registerTool("search", {
		...
		const ec = getEmDash(extra);
		try {
			const { searchWithDb } = await import('./search-By-NN3da_BHnv-BlX.mjs').then((n) => n.t);
	...
	server.registerTool("taxonomy_list", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTaxonomyList } = await import('./taxonomies-CLs9HPE2_BQA_DL6v.mjs').then((n) => n.l);
	...
	server.registerTool("taxonomy_list_terms", {
		...
		try {
			...
			const { decodeCursor, encodeCursor, InvalidCursorError } = await import('./types-ByV5sgsv_DJ3e8Y6Y.mjs').then(n => n.n).then((n) => n.a);
	...
	server.registerTool("taxonomy_create_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermCreate } = await import('./taxonomies-CLs9HPE2_BQA_DL6v.mjs').then((n) => n.l);
	...
	server.registerTool("taxonomy_update_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermUpdate } = await import('./taxonomies-CLs9HPE2_BQA_DL6v.mjs').then((n) => n.l);
	...
	server.registerTool("taxonomy_delete_term", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermDelete } = await import('./taxonomies-CLs9HPE2_BQA_DL6v.mjs').then((n) => n.l);
	...
	server.registerTool("taxonomy_term_translations", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleTermTranslations } = await import('./taxonomies-CLs9HPE2_BQA_DL6v.mjs').then((n) => n.l);
	...
	server.registerTool("menu_list", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuList } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_get", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuGet } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_translations", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuTranslations } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_create", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuCreate } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_update", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuUpdate } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_delete", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuDelete } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("menu_set_items", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleMenuSetItems } = await import('./menus-Bjf5R1Qq_BkGIWiJ8.mjs').then((n) => n.d);
	...
	server.registerTool("settings_get", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleSettingsGet } = await import('./settings-CJnKiWuR_DQ6u9CPP.mjs').then((n) => n.r);
	...
	server.registerTool("settings_update", {
		...
		const ec = getEmDash(extra);
		try {
			const { handleSettingsUpdate } = await import('./settings-CJnKiWuR_DQ6u9CPP.mjs').then((n) => n.r);
