...
import { F as FIELD_TYPES } from './registry-DqrAQDXH_ByM39WgY.mjs';
...
import { I as wpPrepareBody } from './setup-Cf_TyOv5_Da69AHYi.mjs';
import { r as requirePerm } from './authorize-Bkwe8kuL_CyCbUGQn.mjs';
import { s as sanitizeSlug, c as capitalize, a as singularize } from './analyze_YKlOqBDb.mjs';
	...
	for (const postType of request.postTypes) {
		...
		try {
			...
			if ([
				...
				const { FTSManager } = await import('./fts-manager-Mnrtn-r2_V9gjL7bx.mjs').then((n) => n.n);
