...
import { c as createOAuthStateStore } from './oauth-state-store-vOSdOeGe_ByQHPSH3.mjs';
import { createKyselyAdapter } from './kysely_B71kB-eV.mjs';
import { e as handleOAuthCallback, O as OAuthError } from './index_CZ_O-7V7.mjs';
...
const GET = async ({ params, request, locals, session, redirect }) => {
  ...
  try {
    const providers = getOAuthConfig(locals.runtime?.env ?? Object.assign(__vite_import_meta_env__, { EDITOR: "C:\\WINDOWS\\notepad.exe", OS: "Windows_NT" }));
