...
import { r as requestCached, p as peekRequestCache, s as setRequestCacheEntry } from './request-cache-dzCt8TZB_CsgDJ6ch.mjs';
import { g as getDb } from './loader-Chm5h7Gr_VuvI1mhf.mjs';
import { a as resolveLocale, r as resolveLocaleChain } from './resolve-Cj98DuqN_D-2jYj67.mjs';
...
async function getEntriesByTerm(collection, taxonomyName, termSlug, options = {}) {
	const { getEmDashCollection } = await import('./query-BJn8TOPk_cu-tTSgy.mjs').then((n) => n.o);
