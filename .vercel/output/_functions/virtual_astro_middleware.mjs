import { a6 as defineMiddleware, af as sequence } from './chunks/sequence_DO5rsetM.mjs';
import { s as setI18nConfig, r as runMigrations, i as isSqlite, v as validateIdentifier } from './chunks/types-ByV5sgsv_DJ3e8Y6Y.mjs';
import { c as createRequestMetrics, r as runWithContext, g as getRequestContext } from './chunks/request-context_COpWwYmK.mjs';
import { i as isInstrumentationEnabled, c as createRecorder, f as flushRecorder, g as getDb, k as kyselyLogOption } from './chunks/loader-Chm5h7Gr_VuvI1mhf.mjs';
import 'better-sqlite3';
import { Kysely, sql } from 'kysely';
import { c as createNoopSandboxRunner, a as createHookPipeline, d as definePlugin, E as EmailPipeline, r as resolveExclusiveHooks, P as PluginRouteRegistry, b as after } from './chunks/adapt-sandbox-entry_DjK9-r0z.mjs';
import { r as RevisionRepository } from './chunks/content-C0ooIs-f_Bwo8eX_E.mjs';
import { M as MediaRepository } from './chunks/media-oqRcNiQf_LipfpTx8.mjs';
import { O as OptionsRepository } from './chunks/options-BL4X94qY_BcYAYOpH.mjs';
import { i as invalidateSiteSettingsCache } from './chunks/settings-hcubRfkr_CN9G8DMH.mjs';
import { C as CronExecutor } from './chunks/cron-Bd3b3iuj_BoAH8XnB.mjs';
import { n as normalizeMediaValue } from './chunks/normalize-CN5kRSMC_CU3uucGH.mjs';
import 'image-size';
import { E as EmDashStorageError, P as PluginStateRepository, l as loadBundleFromR2, n as normalizeRegistryConfig, h as handleContentList, a as handleContentGet, b as handleContentGetIncludingTrashed, c as handleContentCreate, v as validateRev, d as handleContentUpdate, e as handleContentDelete, f as handleContentListTrashed, g as handleContentRestore, i as handleContentPermanentDelete, j as handleContentCountTrashed, k as handleContentDuplicate, m as handleContentPublish, o as handleContentUnpublish, p as handleContentSchedule, q as handleContentUnschedule, r as handleContentCountScheduled, s as handleContentDiscardDraft, t as handleContentCompare, u as handleContentTranslations, w as handleMediaList, x as handleMediaGet, y as handleMediaCreate, z as handleMediaUpdate, A as handleMediaDelete, B as handleRevisionList, C as handleRevisionGet, D as handleRevisionRestore } from './chunks/api-CLwG_3dh_CQnUFDop.mjs';
import { r as requestCached } from './chunks/request-cache-dzCt8TZB_CsgDJ6ch.mjs';
import { h as hashString } from './chunks/hash-DlUxGhQS_CP43UY8x.mjs';
import { t as FTSManager } from './chunks/fts-manager-Mnrtn-r2_V9gjL7bx.mjs';
import { S as SchemaRegistry } from './chunks/registry-DqrAQDXH_ByM39WgY.mjs';
import { n as normalizeManifestRoute } from './chunks/manifest-schema-Czqf0TLu_DL1mkBBG.mjs';
import '@emdash-cms/plugin-types';
import './chunks/setup-Cf_TyOv5_Da69AHYi.mjs';
import { a as invalidateUrlPatternCache } from './chunks/query-BJn8TOPk_cu-tTSgy.mjs';
import './chunks/import-DG80rC_I_xvWF57jY.mjs';
import { g as getTrustedProxyHeaders } from './chunks/trusted-proxy-97pajC2f_jQH5p4aV.mjs';
import { s as sanitizeHeadersForSandbox, e as extractRequestMeta } from './chunks/request-meta-C_Cjii-T_DOD2oc_A.mjs';
import './chunks/email-console-CubRll9q_BSEoXBnN.mjs';
import mime from 'mime/lite';
import { C as COMMIT, V as VERSION } from './chunks/version-Ct7C6RSo_Db477Nts.mjs';
import { g as getAuthMode } from './chunks/mode-CaaiebZI_DSSHIDlR.mjs';
import { c as cleanupExpiredChallenges } from './chunks/challenge-store-Dng1SxKT_CKFbcTAW.mjs';
import { v as validateEncryptionKeyAtStartup, r as resolveSecretsCached } from './chunks/secrets-rPdhEBkD_BN1YxHO5.mjs';
import 'piccolore';
import 'clsx';
import virtualConfig from './chunks/config_kQwpNaU2.mjs';
import { createRequestScopedDb, createDialect } from './chunks/dialect_D_z8L6bH.mjs';
import 'croner';
...
import { createKyselyAdapter } from './chunks/kysely_B71kB-eV.mjs';
import { R as RedirectRepository } from './chunks/redirect-CNv4mHX2_DtN1rCAr.mjs';
import { n as getCachedRedirects, a as setCachedRedirects, i as matchCachedPatterns } from './chunks/cache-CNk1jIxp_DFeVYLPD.mjs';
import { a as apiError } from './chunks/error-CPh_8eLq_J-oZhpsQ.mjs';
import { g as getPublicOrigin } from './chunks/public-url-CUWWFME2_Hewc1XpU.mjs';
import './chunks/index_CZ_O-7V7.mjs';
import { r as resolveApiToken, a as resolveOAuthToken } from './chunks/api-tokens-ucpcNXDt_DNhUyfCd.mjs';
import { ulid } from 'ulidx';
import { h as hasScope } from './chunks/authenticate-BiDGbUVY_CNGQ9xrZ.mjs';
import { v as verifyPreviewToken, p as parseContentId } from './chunks/tokens-N8otWMmj_DR2qeMwT.mjs';
...
const virtualSandboxRunnerModule = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	__proto__: null,
	createSandboxRunner,
	sandboxEnabled
...
var EmDashRuntime = class EmDashRuntime2 {
  ...
  */
  async syncMarketplacePluginsBypassed() {
    ...
    try {
      ...
      const { adaptSandboxEntry } = await import('./chunks/adapt-sandbox-entry_DjK9-r0z.mjs').then(n => n.e);
      const newPlugins = [];
      for (const [pluginId, version] of desired) {
  ...
  */
  static async create(deps, timings) {
    ...
    const sandboxedPlugins2 = await phase("rt.sandbox", "Sandboxed plugins", () => EmDashRuntime2.loadSandboxedPlugins(deps, db, storage));
    if (deps.config.marketplace && storage && !deps.sandboxBypassed) await phase("rt.market", "Marketplace plugins", () => EmDashRuntime2.loadInstalledSandboxedPlugins("marketplace", db, storage, deps, sandboxedPlugins2));
    if (deps.config.experimental?.registry && storage) await phase("rt.registry", "Registry plugins", () => EmDashRuntime2.loadInstalledSandboxedPlugins("registry", db, storage, deps, sandboxedPlugins2));
    ...
    dbInitPromise = (async () => {
      ...
      try {
        ...
        if (collectionCount.count === 0 && !setupDone) {
          const { applySeed } = await import('./chunks/apply-wJhM_bwU_AvjWwG50.mjs').then((n) => n.n);
          const { loadSeed } = await import('./chunks/load-DmXNVhst_DyTgr651.mjs').then((n) => n.r);
          const { validateSeed } = await import('./chunks/validate-mz87i8_1_BElwTvmd.mjs').then((n) => n.n);
  ...
  */
  ...
  async handleContentCreate(collection, body) {
    ...
    const { validateContentData } = await import('./chunks/validation-DKHhXjPr_DkCKe_5A.mjs');
  ...
  async handleContentUpdate(collection, id, body) {
    const { ContentRepository } = await import('./chunks/content-C0ooIs-f_Bwo8eX_E.mjs').then((n) => n.n);
...
const ASTRO_COOKIES_SYMBOL = /* @__PURE__ */ Symbol.for("astro.cookies");
    ...
    if (!isEmDashRoute && !isPublicRuntimeRoute && !hasEditCookie && !hasPreviewToken) {
      if (!sessionUser && !playgroundDb) {
        ...
        if (!setupVerified) {
          const t0 = performance.now();
          try {
            const { getDb: getDb2 } = await import('./chunks/loader-Chm5h7Gr_VuvI1mhf.mjs').then(n => n.l).then((n) => n.i);
...
const CSRF_EXEMPT_PUBLIC_ROUTES = /* @__PURE__ */ new Set([
  "/_emdash/api/oauth/token",
  "/_emdash/api/oauth/register",
  "/_emdash/api/oauth/device/code",
  "/_emdash/api/oauth/device/token"
...
const onRequest$2 = defineMiddleware(async (context, next) => {
  ...
  if (isTokenAuth) {
    ...
    response2.headers.set("Content-Security-Policy", buildEmDashCsp(context.locals.emdash?.config.experimental?.registry));
    return response2;
  }
  const response = await handleEmDashAuth(context, next);
  response.headers.set("Content-Security-Policy", buildEmDashCsp(context.locals.emdash?.config.experimental?.registry));
  return response;
});
